      ...
      <div class="access-status">
        ...
        <div style="padding-top: 20px;">
          <el-table
            ...
            tooltip-effect="dark" 
            stripe>
            <el-table-column prop="configs.chanName" label="通道名称" width="220">
              <template slot-scope="scope">
                <span>{{scope.row.configs.chanName}}</span>
              </template>
            </el-table-column>
            <el-table-column prop="configs.chanCode" label="压缩通道ID" width="282"></el-table-column>
            <el-table-column prop="configs.inputAddr" label="IP地址" width="262"></el-table-column>
            ...
            <el-table-column prop="onlineNum" label="状态" width="142">
              <template slot-scope="scope">
                <span>{{scope.row.configs.onlineNum=='0'?'离线':'在线'}}</span>
              </template>
            </el-table-column>
